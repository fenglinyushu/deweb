...
procedure TDemos.Button11Click(Sender: TObject);
begin
     Button10.Left  := Button10.Left+5;
     Button10.Top   := Button10.Top+5;
end;

procedure TDemos.Button13Click(Sender: TObject);
begin
...
procedure TDemos.Button17Click(Sender: TObject);
begin
...
procedure TDemos.Button18Click(Sender: TObject);
begin
...
procedure TDemos.Button21Click(Sender: TObject);
begin
...
procedure TDemos.Button22Click(Sender: TObject);
begin
...
procedure TDemos.Button23Click(Sender: TObject);
begin
...
procedure TDemos.Button26Click(Sender: TObject);
begin
...
procedure TDemos.Button27Click(Sender: TObject);
begin
     with Panel4 do begin
          Visible   := True;
          Width     := Width + 5;
...
procedure TDemos.Button28Click(Sender: TObject);
begin
     Panel4.Enabled := not Panel4.Enabled;
end;

procedure TDemos.Button29Click(Sender: TObject);
begin
     RadioButton6.Checked   := not RadioButton6.Checked;

end;

procedure TDemos.Button30Click(Sender: TObject);
begin
...
procedure TDemos.Button31Click(Sender: TObject);
begin
...
procedure TDemos.Button32Click(Sender: TObject);
begin
...
procedure TDemos.Button34Click(Sender: TObject);
begin
     SpinEdit2.Enabled   := not SpinEdit2.Enabled;
end;

procedure TDemos.Button35Click(Sender: TObject);
begin
...
procedure TDemos.Button36Click(Sender: TObject);
begin
...
procedure TDemos.Button37Click(Sender: TObject);
begin
...
procedure TDemos.Button38Click(Sender: TObject);
begin
...
procedure TDemos.Button40Click(Sender: TObject);
begin
     SpinEdit6.MinValue  := -15;
     SpinEdit6.MaxValue  := 15;
end;

procedure TDemos.Button41Click(Sender: TObject);
begin
     ComboBox2.Enabled   := Not ComboBox2.Enabled;
end;

procedure TDemos.Button42Click(Sender: TObject);
begin
...
procedure TDemos.Button43Click(Sender: TObject);
begin
...
procedure TDemos.Button46Click(Sender: TObject);
begin
...
procedure TDemos.Button47Click(Sender: TObject);
begin
...
procedure TDemos.Button48Click(Sender: TObject);
begin
     DateTimePicker6.Date     := DateTimePicker6.Date+1;
     DateTimePicker7.Time     := DateTimePicker7.Time+0.0151;
end;

procedure TDemos.Button49Click(Sender: TObject);
begin
     Image3.Visible := not Image3.Visible;
end;

procedure TDemos.Button50Click(Sender: TObject);
begin
...
procedure TDemos.Button51Click(Sender: TObject);
begin
     with Image3 do begin
          Width     := Width + 5;
          Height    := Height +5;
...
procedure TDemos.Button52Click(Sender: TObject);
begin
     ListBox1.Visible := not ListBox1.Visible;

end;

procedure TDemos.Button53Click(Sender: TObject);
begin
...
procedure TDemos.Button54Click(Sender: TObject);
begin
     with ListBox1 do begin
          Width     := Width + 5;
          Height    := Height +5;
...
procedure TDemos.Button55Click(Sender: TObject);
begin
     ListBox1.Enabled := not ListBox1.Enabled;

end;

procedure TDemos.Button56Click(Sender: TObject);
var
     sValue    : string;
     I         : Integer;
begin
...
procedure TDemos.Button58Click(Sender: TObject);
begin
     Memo1.Visible  := not Memo1.Visible;
end;

procedure TDemos.Button59Click(Sender: TObject);
begin
     Memo1.Enabled     := not Memo1.Enabled;
end;

procedure TDemos.Button60Click(Sender: TObject);
begin
     with Memo1 do begin
          Width     := Width + 5;
          Height    := Height +5;
...
procedure TDemos.Button61Click(Sender: TObject);
begin
     with Memo1 do begin
          Left := Left + 5;
          Top  := Top +5;
...
procedure TDemos.Button65Click(Sender: TObject);
begin
     MonthCalendar1.Enabled   := not MonthCalendar1.Enabled;
end;

procedure TDemos.Button66Click(Sender: TObject);
begin
...
procedure TDemos.Button67Click(Sender: TObject);
begin
     with MonthCalendar1 do begin
          Width     := Width + 5;
          Height    := Height +5;
...
procedure TDemos.Button70Click(Sender: TObject);
begin
     PageControl1.Visible     := not PageControl1.Visible;
end;

procedure TDemos.Button71Click(Sender: TObject);
begin
     PageControl1.Enabled     := not PageControl1.Enabled;

end;

procedure TDemos.Button72Click(Sender: TObject);
begin
...
procedure TDemos.Button73Click(Sender: TObject);
begin
     with PageControl1 do begin
          Left := Left + 5;
          Top  := Top +5;
...
procedure TDemos.Button75Click(Sender: TObject);
begin
...
procedure TDemos.Button76Click(Sender: TObject);
begin
     StringGrid1.Visible := not StringGrid1.Visible;
end;

procedure TDemos.Button77Click(Sender: TObject);
begin
     StringGrid1.Enabled := not StringGrid1.Enabled;

end;

procedure TDemos.Button78Click(Sender: TObject);
begin
...
procedure TDemos.Button79Click(Sender: TObject);
begin
     with StringGrid1 do begin
          Left := Left + 5;
          Top  := Top +5;
...
procedure TDemos.Button83Click(Sender: TObject);
begin
     TreeView1.Enabled   := not TreeView1.Enabled;

end;

procedure TDemos.Button84Click(Sender: TObject);
begin
...
procedure TDemos.Button85Click(Sender: TObject);
begin
     with TreeView1 do begin
          Left := Left + 5;
          Top  := Top +5;
...
procedure TDemos.Button9Click(Sender: TObject);
begin
...
procedure TDemos.FormCreate(Sender: TObject);
var
     iC,iR     : Integer;
begin
     Top  := 20;
...
procedure TDemos.FormMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
     //
end;
...
procedure TDemos.PageControl1Change(Sender: TObject);
begin
...
procedure TDemos.RadioButton8Click(Sender: TObject);
begin
     //
